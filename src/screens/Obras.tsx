...
export default function Obras() {
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize filtered lists to prevent redundant filtering on every re-render
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize tabs configuration to maintain referential stability
                  ...
                  <div className="relative aspect-square overflow-hidden bg-surface-raised">
                    {obra.cover_image || obra.artwork_images?.[0] ? (
                      <img src={obra.cover_image || obra.artwork_images![0]} alt={obra.artwork_title}
                        /* ⚡ BOLT OPTIMIZATION: Lazy load images to improve initial page load and scroll performance */
                        loading="lazy"
