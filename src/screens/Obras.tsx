...
export default function Obras() {
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize filtered lists to prevent re-filtering on every render
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize tabs array to prevent unnecessary re-renders of the tabs component
