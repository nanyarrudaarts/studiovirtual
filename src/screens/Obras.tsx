...
export default function Obras() {
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize filtered lists to prevent redundant filtering on every render
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize tabs configuration to prevent object recreation on every render
