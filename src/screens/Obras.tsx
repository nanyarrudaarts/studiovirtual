...
export default function Obras() {
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize filtered lists to avoid re-filtering on every render
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize tabs configuration to prevent object recreation
