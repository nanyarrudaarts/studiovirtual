...
export default function Obras() {
  ...
  // ⚡ BOLT OPTIMIZATION: Memoizing filtered data to prevent expensive array operations on every render
  ...
  // ⚡ BOLT OPTIMIZATION: Memoizing UI config to avoid unnecessary object re-allocations
                  ...
                  <div className="relative aspect-square overflow-hidden bg-surface-raised">
                    {obra.cover_image || obra.artwork_images?.[0] ? (
                      <img src={obra.cover_image || obra.artwork_images![0]} alt={obra.artwork_title}
                        // ⚡ BOLT OPTIMIZATION: Lazy loading images to improve initial TBT and bandwidth
                        loading="lazy"
