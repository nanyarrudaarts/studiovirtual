...
export default function Obras() {
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize filtered results to avoid recalculation on unrelated renders
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize tabs array to prevent redundant object creation
