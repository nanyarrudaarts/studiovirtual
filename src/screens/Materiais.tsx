  ...
  return (
    <div className="max-w-[1200px] mx-auto pb-12 relative">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-serif mb-2">{t('inventario_materiais')}</h1>
        ...
        >
          <Plus size={20} /> {t('cadastrar_material').replace('+ ', '')}
        </button>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-surface w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              <h2 className="text-xl font-serif">{t('cadastrar_material').replace('+ ', '')}</h2>
            ...
            <div className="p-6 max-h-[70vh] overflow-y-auto">
              ...
              <div className="mb-6">
                <button className="w-full border-2 border-dashed border-accent/30 bg-accent/5 text-accent py-6 rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-accent/10 transition-colors">
                  <Camera size={28} />
                  <span className="font-bold">{t('identificar_foto')}</span>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <label className="block text-sm font-bold text-text-muted mb-1">{t('nome')}</label>
                ...
                <div>
                  <label className="block text-sm font-bold text-text-muted mb-1">{t('marca')}</label>
                  <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm focus:border-accent outline-none bg-bg" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-text-muted mb-1">{t('categoria')}</label>
                ...
                <div>
                  <label className="block text-sm font-bold text-text-muted mb-1">{t('quantidade')}</label>
                ...
                <div>
                  <label className="block text-sm font-bold text-text-muted mb-1">{t('unidade')}</label>
                  <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm focus:border-accent outline-none bg-bg" />
                </div>
                <div className="col-span-2">
                ...
                <div>
                  <label className="block text-sm font-bold text-text-muted mb-1">{t('data_aquisicao')}</label>
                ...
                <div className="col-span-2">
                  <label className="block text-sm font-bold text-text-muted mb-1">{t('notas')}</label>
