...
export default function Dashboard() {
  ...
  // Memoize locale object to prevent recreation on every render
  ...
  useEffect(() => {
    async function loadDashboardData() {
      ...
      try {
        ...
        // ⚡ BOLT OPTIMIZATION: Calculate health score based on correct Artwork type fields
        const healthScore =
  ...
  // Memoize date string to prevent recalculation on every render
